        ...
        <div className="page page-wrapper" >
            ...
            <section className="section section-1 m-auto relative" >
                <div className="h-full">
                    <Image src="/images/casting_bg.png" alt="DesigNova" width={0} height={0} sizes="100vw" className="lg:w-full lg:h-screen xl:w-full xl:h-screen w-full h-screen object-cover" quality={100} />
